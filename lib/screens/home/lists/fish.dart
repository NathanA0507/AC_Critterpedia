...
///Shows a detailed screen for a fish
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            Image.asset(
                'assets/fish/NH-Icon-${fish.name.toLowerCase().replaceAll(" ", '').replaceAll('-', '').replaceAll("'", '').replaceAll(".", '')}.png'),
            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Jan"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Feb"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Mar"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Apr"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("May"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Jun"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Jul"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Aug"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Sep"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Oct"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Nov"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
                ...
                Container(
                  ...
                  width: 50,
                  child: Card(
                      color: (fish.months_n.contains("Dec"))
                          ? Colors.green[400]
                          : Colors.grey,
                      child: Center(
                          child: Text(
